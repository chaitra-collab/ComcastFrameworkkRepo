...
public class DeleeteOrgTest {
//handlingdynamicelementinpom
...
//        		 //indynamicwebtable select and delete org
//        		 //driver.findinruntimewecanfinddynamicelemnt
//        		 driver.findElement(By.xpath("//a[text()='"+orgName+"']/../../td[8]/a[text()='del']")).click();
////dynamicdata        		 //usingpomwecantstoredynamicelements//usevafiableconcatenateorgName
//  
        		 cnp.getSearchEdt().sendKeys(orgName);
        		 wLib.select(cnp.getSearchDD(), "Organization Name");
        		 cnp.getSearchBtn().click();

        		 cnp.deleteOrganization(driver, orgName);
        		 //STEP 5 LOGOUT
        		 hp.logOut();
         driver.quit();
